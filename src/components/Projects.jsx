...
const Projects = () => {
  const projects = [
    {
      title: "MediaStack",
      desc: "Multi-user blogging platform where creators can publish, manage, and edit content from a personal dashboard. Features authentication, role-based access, and scalable REST API architecture.",
    ...
    },
    {
      ...
      desc: "Secure backend ledger system for managing transactions, user accounts, and financial records. Implements authentication, data validation, and structured API endpoints following MVC architecture.",
      tech: ["#Node.js", "#Express", "#MongoDB", "#RESTAPI", "#JWT"],
      role: "Backend Dev",
      live: "#",
      github: "https://github.com/mohdahtesham09",
    },
    {
      title: "SmailyZo – AI Appointment System",
      desc: "AI-powered appointment booking system for dental clinics with real-time conversational interaction. Integrated Vapi voice AI and n8n workflows for automated scheduling, CRM updates, and call logging.",
      tech: ["#TypeScript", "#React", "#Vapi", "#n8n"],
      role: "AI Automation",
      live: "#",
      github: "https://github.com/mohdahtesham09",
    },
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mt-12 text-center'>
          <a
            ...
            target='_blank'
            rel='noopener noreferrer'
            className='inline-flex items-center gap-2 text-white bg-white/10 hover:bg-white/20 px-6 py-3 rounded-full backdrop-blur-md border border-white/20 transition-all'
          >
